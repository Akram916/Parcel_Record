package com.akram.parcelrecord;
...
import com.akram.parcelrecord.databinding.ActivityMainBinding;
    ...
    public void RefreshList() {
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                final CharSequence[] dialogitem = {"View Parcel", "Update Parcel", "Delete Parcel"};
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            case 0:
                                Intent i = new Intent(getApplicationContext(), ViewParcelActivity.class);
                                i.putExtra("name", selection);
                                startActivity(i);
                                break;
                            case 1:
                                Intent in = new Intent(getApplicationContext(), UpdateParcelActivity.class);
